markdown# Living Research Protocol
...
**Major changes from v3.3:**
- Added **"Is This For You?"** – 30-second decision gate
- Added **plain-prose QITCS option** – no YAML required
- Added **Examples Across Domains** – shows LRP works everywhere
- Final polish: ready for any researcher, any field, any skill level
